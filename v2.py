...
PUBLIC_IP = '45.20.184.85'

# Admin user IDs - add your admin user IDs here
ADMIN_IDS = [1366647739206864926]  # Replace with actual admin IDs
...
async def change_status():
    try:
        ...
        status = f" RAJVEER CLOUd {instance_count} VPS MADE By RAJVEER"
        await bot.change_presence(activity=discord.Gam e(name=status))
    except Exception as e:
